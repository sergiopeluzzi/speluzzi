...
<nav class="white" role="navigation">
    <div class="nav-wrapper container">
        <a id="logo-container" href="/" class="brand-logo">SPeluzzi</a>
...
<div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
        <div class="container">
            <br><br>
            <h1 class="header center teal-text text-lighten-2">Sergio Peluzzi</h1>
            <div class="row center">
                <h5 class="header col s12 light">Desenvolvimento Web</h5>
            </div>
            <div class="row center">
                <a href="/contato" id="download-button" class="btn-large waves-effect waves-light teal lighten-1">Contato</a>
            </div>
            <br><br>
        ...
        <div class="row">
            <div class="col s12 m4">
                <div class="icon-block">
                    ...
                    <h5 class="center">Desenvolvimento Ágil</h5>
            ...
            <div class="col s12 m4">
                <div class="icon-block">
                    ...
                    <h5 class="center">Experiência de Usuário</h5>
            ...
            <div class="col s12 m4">
                <div class="icon-block">
                    ...
                    <h5 class="center">Tecnologias Avançadas</h5>
